...
for filename in File_Names:
  ...
  #print(wind)
  #print(power)
  total_wind.append(wind)
  total_power.append(power)
  # Create the plot
  #plt.plot(total_wind, total_power, marker='o', linestyle='-')
...
for i in range(len(total_wind)):
    plt.plot(total_wind[i], total_power[i], marker='o', linestyle='-', label=File_Names[i])

# Formatting
plt.xlabel('Wind Speed (m/s)')
plt.ylabel('Power (W)')
plt.title('Wind Speed vs Power for Different Scenarios')
