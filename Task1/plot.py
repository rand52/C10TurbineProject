...
def plot_data(data_arrays,labels = None, save =False):
    ...
    plt.xlabel(r'Velocity $\left[\frac{\mathit{m}}{\mathit{s}}\right]$', fontsize=20)
    plt.ylabel("Power produced[W]", fontsize=20)
    plt.legend()
