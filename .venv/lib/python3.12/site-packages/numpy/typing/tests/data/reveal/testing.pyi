...
assert_type(np.testing.rundocs("velocity_map_data_plotter_frames.py"), None)
assert_type(np.testing.rundocs(Path("velocity_map_data_plotter_frames.py"), raise_on_error=True), None)
