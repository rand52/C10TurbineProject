...
pt_along_z_bot_index = mt.floor((num_pts_in_y - 1) / 2)*num_pts_in_z
pt_along_z_mid_index = mt.floor((num_pts_in_y - 1) / 2)*num_pts_in_z + mt.floor(num_pts_in_z / 2)
pt_along_z_top_index = mt.floor((num_pts_in_y - 1) / 2)*num_pts_in_z + (num_pts_in_z - 1)
...
print()
print(pt_along_y_left_index)
print(pt_along_y_mid_index)
print(pt_along_y_right_index)
print()
...
print()
print(pt_along_z_bot_index)
print(pt_along_z_mid_index)
print(pt_along_z_top_index)
